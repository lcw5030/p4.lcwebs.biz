...
class races_controller extends base_controller
{
    ...
    public function index()
    {
        ...
        $this->template->title   = "All Race Events";
        
        # Query
        $q = 'SELECT *
        FROM races';
        
        # Run the query, store the results in the variable $races
        $races = DB::instance(DB_NAME)->select_rows($q);
        
        # Pass data to the View
        $this->template->content->races = $races;
